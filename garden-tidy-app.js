...
(() => {
  ...
  function GardenTidyApp() {
    ...
    const flaggedTrees = trees.filter(t => analysis.treeFlags[t.id].length > 0);
    const flaggedShrubs = shrubs.filter(s => analysis.shrubFlags[s.id].length > 0);
    ...
    return React.createElement("div", {
      ...
      opacity: "0.6",
      pointerEvents: "none"
    })), analysis.pairLines.filter(p => p.kind === "touch").map((p, i) => React.createElement("line", {
      key: `t${i}`,
      x1: p.a.x,
      y1: p.a.y,
      x2: p.b.x,
      ...
      opacity: "0.55",
      pointerEvents: "none"
    })), analysis.pairLines.filter(p => p.kind === "sightline").map((p, i) => {
    ...
    }), analysis.blockLines.map((b, i) => React.createElement("line", {
      key: `b${i}`,
      x1: b.from.x,
      y1: b.from.y,
      x2: b.to.x,
